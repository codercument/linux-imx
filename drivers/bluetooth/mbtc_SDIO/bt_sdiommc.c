...
EXPORT_SYMBOL_GPL(sd_enable_host_int_mask);
...
EXPORT_SYMBOL_GPL(sd_read_cmd52_val);
/**
...
EXPORT_SYMBOL_GPL(sd_write_cmd52_val);
/**
 *  @brief This function updates card reg based on the Cmd52 value in dev structure
 *
 *  @param priv     A pointer to bt_private structure
...
EXPORT_SYMBOL_GPL(sd_write_reg);
/**
 *  @brief This function reads updates the Cmd52 value in dev structure
 *
 *  @param priv     A pointer to bt_private structure
...
EXPORT_SYMBOL_GPL(sbi_register);
/**
...
EXPORT_SYMBOL_GPL(sbi_unregister);
...
EXPORT_SYMBOL_GPL(sbi_register_dev);
/**
...
EXPORT_SYMBOL_GPL(sbi_unregister_dev);
/**
...
EXPORT_SYMBOL_GPL(sd_enable_host_int);
/**
...
EXPORT_SYMBOL_GPL(sd_disable_host_int);
/**
...
EXPORT_SYMBOL_GPL(sbi_host_to_card);
/**
...
EXPORT_SYMBOL_GPL(sbi_download_fw);
/**
...
EXPORT_SYMBOL_GPL(sbi_get_int_status);
/**
...
EXPORT_SYMBOL_GPL(sbi_wakeup_firmware);
...
EXPORT_SYMBOL_GPL(sdio_update_card_type);
/**
...
EXPORT_SYMBOL_GPL(sdio_get_sdio_device);
...
EXPORT_SYMBOL_GPL(bt_dump_sdio_regs);
module_param(fw_name, charp, 0);
MODULE_PARM_DESC(fw_name, "Firmware name");
module_param(bt_req_fw_nowait, int, 0);
EXPORT_SYMBOL_GPL(bt_req_fw_nowait);
