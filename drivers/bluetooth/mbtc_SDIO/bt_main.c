...
/** Driver version */
static char mbt_driver_version[] = "SD8XXX-001--Ercument";
...
EXPORT_SYMBOL_GPL(clean_up_m_devs);
/**
...
EXPORT_SYMBOL_GPL(check_evtpkt);
/**
...
EXPORT_SYMBOL_GPL(bt_process_event);
/**
...
EXPORT_SYMBOL_GPL(bt_dump_firmware_info_v2);
/**
...
EXPORT_SYMBOL_GPL(bt_get_histogram);
/**
...
EXPORT_SYMBOL_GPL(bt_set_mac_address);
/**
...
EXPORT_SYMBOL_GPL(bt_load_cal_data);
/**
...
EXPORT_SYMBOL_GPL(bt_load_cal_data_ext);
/**
...
EXPORT_SYMBOL_GPL(bt_write_reg);
/**
...
EXPORT_SYMBOL_GPL(bt_prepare_command);
...
EXPORT_SYMBOL_GPL(bt_request_fw_reload);
/**
...
EXPORT_SYMBOL_GPL(bt_free_adapter);
/**
...
mdev_open(struct m_dev *m_dev)
{
	...
	if (try_module_get(m_dev->owner) == 0)
		return BT_STATUS_FAILURE;
...
EXPORT_SYMBOL_GPL(bt_interrupt);
static void
...
EXPORT_SYMBOL_GPL(sbi_register_conf_dpc);
/**
...
EXPORT_SYMBOL_GPL(bt_remove_card);
/**
...
EXPORT_SYMBOL_GPL(bt_fw_reload);
...
EXPORT_SYMBOL_GPL(bt_fw_serial);
